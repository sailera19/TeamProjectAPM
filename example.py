...
net_g_n = run_alpha_plus_algorithm(traces_filtered_dataset, min_support=0.45, include_start_end=True, per_node=False,
                               filter_full_trace=False, activity_map=activity_map_filtered_dataset, detect_loops=True)
net_g_n.save('nets/happypath_infrequent_global__filter_nodes_only.png')
                               
# Infrequent global (Happy Path), filter full traces
net_g_t = run_alpha_plus_algorithm(traces_filtered_dataset, min_support=0.45, include_start_end=True, per_node=False,
                               filter_full_trace=True, activity_map=activity_map_filtered_dataset, detect_loops=True)
...
# No filtering
net_all = run_alpha_plus_algorithm(traces_filtered_dataset, min_support=None, activity_map=activity_map_filtered_dataset, detect_loops=True)
